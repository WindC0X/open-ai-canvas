...
export function CanvasProjectMediaDialogs({
    ...
    return (
        <>
            ...
            {outpaintNode && canvasContainerRef.current ? <CanvasNodeOutpaintOverlay node={outpaintNode.metadata?.content ? outpaintNode : null} containerRef={canvasContainerRef} config={config} onClose={onCloseOutpaint} onExecute={onOutpaint} /> : null}
